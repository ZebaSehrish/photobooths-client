...
const FAQ = () => {
    return (
        <div className='relative w-full h-full'>
            <div className='w-full faq-img'>
                <img src={img1} className='w-full faq-background ' alt="" />
            </div>
            <div className="absolute flex justify-end transform -translate-y-1/2 left-24 top-1/2">
                <div className='text-base md:text-lg lg:text-xl font-bold text-white'>
                    ...
                    <div className='pr-10 md:pr-16 lg:pr-32'>
                        <p className=' font-normal md:font-normal lg:font-medium'>  How much does professional photography cost?</p>
                    ...
                    <div className='pr-10 md:pr-16 lg:pr-32'>
                        <p className='font-thin md:font-normal lg:font-medium'>How to write a good brief for a professional photographer </p>
                    ...
                    <div className='pr-10 md:pr-16 lg:pr-32'>
                        <p className='font-thin md:font-normal lg:font-medium'>How do I take my own product photographs at home?</p>
