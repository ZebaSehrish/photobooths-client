    ...
    return (
        <div id={`slide${id}`} className="carousel-item relative w-full h-full">
            ...
            <div className="absolute flex justify-end transform -translate-y-1/2 w-2/5 left-24 top-1/2">
                <p className='text-xl text-white'>Our work can be seen in catalogues, editorial, advertising, design, publishing, online and in print, both still and in motion.</p>
            </div>
